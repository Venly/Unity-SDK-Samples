...
public class CharacterInputController : MonoBehaviour
{
	...
	protected void Update ()
    {
        ...
        else
        {
            ...
            else if ((Input.GetKeyDown(KeyCode.RightArrow) || Input.GetKeyDown(KeyCode.D)) && TutorialMoveCheck(0))
            {
                ChangeLane(1);
                      ...
                      Input.GetKeyDown(KeyCode.Z)) && TutorialMoveCheck(1))
            {
                Jump();
            }
        ...
        if ((Input.GetKeyDown(KeyCode.LeftArrow) || Input.GetKeyDown(KeyCode.A) || Input.GetKeyDown(KeyCode.Q)) && TutorialMoveCheck(0))
        {
            ChangeLane(-1);
        }
        else if((Input.GetKeyDown(KeyCode.RightArrow) || Input.GetKeyDown(KeyCode.D)) && TutorialMoveCheck(0))
        ...
        else if((Input.GetKeyDown(KeyCode.UpArrow) || Input.GetKeyDown(KeyCode.W) || Input.GetKeyDown(KeyCode.Z)) && TutorialMoveCheck(1))
        {
            Jump();
        }
		else if ((Input.GetKeyDown(KeyCode.DownArrow) || Input.GetKeyDown(KeyCode.S))&& TutorialMoveCheck(2))
