...
public class GameOverState : AState
{
    ...
    public override void Enter(AState from)
    {
        ...
        miniLeaderboard.Refresh();

  //      miniLeaderboard.playerEntry.inputName.text = PlayerDataWeb3.instance.previousName;
  //      miniLeaderboard.playerEntry.score.text = trackManager.score.ToString();
		//miniLeaderboard.Populate();

        if (PlayerDataWeb3.instance.AnyMissionComplete())
    ...
    protected void FinishRun()
    {
		...
		//else
		//{
		//	PlayerDataWeb3.instance.previousName = miniLeaderboard.playerEntry.inputName.text;
		//}

  //      PlayerDataWeb3.instance.InsertScore(trackManager.score, miniLeaderboard.playerEntry.inputName.text );
