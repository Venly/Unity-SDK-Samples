...
public class GameState : AState
{
    ...
    public GameOverUI gameOverPopup;
    ...
    public void StartGame()
    {
        ...
        m_IsTutorial = !PlayerDataWeb3.instance.tutorialDone;
    ...
    {
        //TODO: Change To SummaryScreen

        //premiumForLifeButton.interactable = PlayerDataWeb3.instance.premium >= 3;
        //premiumCurrencyOwned.text = PlayerDataWeb3.instance.premium.ToString();

        ClearPowerup();

        gameOverPopup.gameObject.SetActive(true);
        gameOverPopup.HandleEndSession(trackManager.characterController.coins, trackManager.score);
    }
    ...
    public void PremiumForLife()
    {
        ...
        //PlayerDataWeb3.instance.premium -= 3;
    ...
    {
        PlayerDataWeb3.instance.tutorialDone = true;
        PlayerDataWeb3.instance.SaveLocalData();
