...
public class SettingPopup : MonoBehaviour
{
    ...
    public void MasterVolumeChangeValue(float value)
    {
        ...
        PlayerDataWeb3.instance.masterVolume = m_MasterVolume;
    }
    ...
    public void MusicVolumeChangeValue(float value)
    {
        ...
        PlayerDataWeb3.instance.musicVolume = m_MusicVolume;
    }
    ...
    public void MasterSFXVolumeChangeValue(float value)
    {
        ...
        PlayerDataWeb3.instance.masterSFXVolume = m_MasterSFXVolume;
    }
}
